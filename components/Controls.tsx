...
const Online: React.FC<Props> = ({tool, palette, color, range, onColorChange, onRangeChange, onView, onEyeDropper, onClear}) => {
    ...
    return (
        <div>
            <Modal className="modal" dismissible show={clearModal} size="md" onClose={() => setClearModal(false)} popup>
                <Modal.Header />
                <Modal.Body>
                    <div className="text-center">
                        <HiOutlineExclamationCircle className="mx-auto mb-4 h-14 w-14 text-white-400 dark:text-white-200" />
                        <h3 className="mb-5 text-lg font-normal text-white-500 dark:text-white-400">
